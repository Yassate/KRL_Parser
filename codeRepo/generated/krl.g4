...
functionDefinition
   : GLOBAL? DEFFCT typeVar functionName formalParameters NEWLINE routineBody ENDFCT
   ;
...
structureDefinition
   : GLOBAL? STRUC typeName typeVar variableName variableListRest (',' typeVar variableName variableListRest)*
   ;
...
variableDeclaration
   : DECL? (typeVar variableName variableListRest | signalDeclaration)
   ;
...
variableDeclarationInDataList
   : DECL? GLOBAL? CONST? (typeVar variableName (variableListRest | variableInitialisation) | signalDeclaration)
   ;
...
forwardDeclaration
   ...
   | EXTFCT typeVar functionName formalParametersWithType
   ;
...
importStatement
   : IMPORT typeVar variableName IS '/R1/' moduleName '..' variableName
   ;
